<!--
id: 31ab9b67a63811ed8cc568545a57002a
title: 我有一台专业微单和九支镜头，我最喜欢用手机摄影
date: 2023/2/6
color: #64b5f6
brief: 作者在这篇文章当中聊了聊自己对手机摄影的理解，并分享了自己深度使用手机摄影软件Varlens的体验
cover: https://picx.zhimg.com/80/v2-c37946c017304c3e7a9c2576744ac501_1440w.webp?source=1940ef5c
cover-caption: 
type: share
published: true
-->
...
得益于手机强大的计算力，我在使用手机拍照时经常使用摄影软件帮助我拍摄。它们通过各种算法榨干手机的性能，帮助我捕获理想的照片。
...
Varlens的人像模式是我目前在Varlens当中使用最多的功能，因为它支持先拍照后对焦，同时虚拟光圈效果比苹果自带相机要好。
...
在使用Varlens的时候，时不时会在后期编辑保存图片的过程中遇到一些裁剪Bug。比如我裁剪了4:3，但是我裁剪完进行了其他编辑保存的时候，图片会被放大。只有我在保存前停留在裁剪界面前裁剪才会生效。不过这个Bug只有在很少的时候会发生，希望之后更新可以修复~
